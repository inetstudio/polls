        ...
        <div class="row">
            ...
            <div class="col-2">
                <div class="float-right">
                    <a href="#" class="btn btn-xs btn-default edit-option m-r-xs"
                       v-on:click.prevent.stop="editOption"><i class="fa fa-pencil-alt"></i></a>
                    <a href="#" class="btn btn-xs btn-danger delete-option" v-on:click.prevent.stop="removeOption"><i
