<template>
    <div id="add_poll_widget_modal" tabindex="-1" role="dialog" aria-hidden="true" class="modal inmodal fade"
         ref="modal">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="ibox-content" v-bind:class="{ 'sk-loading': options.loading }">
                        ...
                        />
                        <p class="text-right"><a href="#" class="btn btn-xs btn-primary"
                                                 v-on:click.prevent="createPoll">Создать новый</a></p>
                    </div>
                </div>
