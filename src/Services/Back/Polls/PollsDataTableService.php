...
use InetStudio\Polls\Contracts\Services\Back\Polls\PollsDataTableServiceContract;
...
class PollsDataTableService extends DataTable implements PollsDataTableServiceContract
{
    ...
    {
        $transformer = app()->make('InetStudio\Polls\Contracts\Transformers\Back\Polls\PollTransformerContract');
